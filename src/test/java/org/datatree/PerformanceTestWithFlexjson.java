...
import org.datatree.dom.adapters.JsonFlex;

/**
 * PerformanceTestWithFlexjson.java
 * 
 * @author Andras Berkes [andras.berkes@programmer.net]
 */
public class PerformanceTestWithFlexjson extends PerformanceTest {

	protected void setUp() throws Exception {
		JsonFlex impl = new JsonFlex();
