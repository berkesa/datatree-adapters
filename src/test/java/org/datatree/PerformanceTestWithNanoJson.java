...
import org.datatree.dom.adapters.JsonNano;

/**
 * PerformanceTestWithNanoJson.java
 * 
 * @author Andras Berkes [andras.berkes@programmer.net]
 */
public class PerformanceTestWithNanoJson extends PerformanceTest {

	protected void setUp() throws Exception {
		JsonNano impl = new JsonNano();
