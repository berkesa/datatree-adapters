...
import org.datatree.dom.adapters.JsonUtil;

/**
 * PerformanceTestWithJsonUtil.java
 * 
 * @author Andras Berkes [andras.berkes@programmer.net]
 */
public class PerformanceTestWithJsonUtil extends PerformanceTest {

	protected void setUp() throws Exception {
		JsonUtil impl = new JsonUtil();
