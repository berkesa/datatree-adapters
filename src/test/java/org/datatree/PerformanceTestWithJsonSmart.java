...
import org.datatree.dom.adapters.JsonSmart;

/**
 * PerformanceTestWithJsonSmart.java
 * 
 * @author Andras Berkes [andras.berkes@programmer.net]
 */
public class PerformanceTestWithJsonSmart extends PerformanceTest {

	protected void setUp() throws Exception {
		JsonSmart impl = new JsonSmart();
