...
import org.datatree.dom.adapters.JsonFast;

/**
 * PerformanceTestWithFastJson.java
 * 
 * @author Andras Berkes [andras.berkes@programmer.net]
 */
public class PerformanceTestWithFastJson extends PerformanceTest {

	protected void setUp() throws Exception {
		JsonFast impl = new JsonFast();
