...
import org.datatree.dom.adapters.JsonGson;

/**
 * PerformanceTestWithGson.java
 * 
 * @author Andras Berkes [andras.berkes@programmer.net]
 */
public class PerformanceTestWithGson extends PerformanceTest {

	protected void setUp() throws Exception {
		JsonGson impl = new JsonGson();
