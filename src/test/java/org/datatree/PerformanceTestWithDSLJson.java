...
import org.datatree.dom.adapters.JsonDSL;

/**
 * PerformanceTestWithDSLJson.java
 * 
 * @author Andras Berkes [andras.berkes@programmer.net]
 */
public class PerformanceTestWithDSLJson extends PerformanceTest {

	protected void setUp() throws Exception {
		JsonDSL impl = new JsonDSL();
