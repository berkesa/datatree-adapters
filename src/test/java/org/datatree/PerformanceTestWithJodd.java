...
import org.datatree.dom.adapters.JsonJodd;

/**
 * PerformanceTestWithJodd.java
 * 
 * @author Andras Berkes [andras.berkes@programmer.net]
 */
public class PerformanceTestWithJodd extends PerformanceTest {

	protected void setUp() throws Exception {
		JsonJodd impl = new JsonJodd();
