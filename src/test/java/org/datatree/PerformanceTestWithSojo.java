...
import org.datatree.dom.adapters.JsonSojo;

/**
 * PerformanceTestWithSojo.java
 * 
 * @author Andras Berkes [andras.berkes@programmer.net]
 */
public class PerformanceTestWithSojo extends PerformanceTest {

	protected void setUp() throws Exception {
		JsonSojo impl = new JsonSojo();
