...
import org.datatree.dom.adapters.JsonJackson;

/**
 * PerformanceTestWithJackson.java
 * 
 * @author Andras Berkes [andras.berkes@programmer.net]
 */
public class PerformanceTestWithJackson extends PerformanceTest {

	protected void setUp() throws Exception {
		JsonJackson impl = new JsonJackson();
