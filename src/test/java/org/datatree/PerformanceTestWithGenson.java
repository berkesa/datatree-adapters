...
import org.datatree.dom.adapters.JsonGenson;

/**
 * PerformanceTestWithGenson.java
 * 
 * @author Andras Berkes [andras.berkes@programmer.net]
 */
public class PerformanceTestWithGenson extends PerformanceTest {

	protected void setUp() throws Exception {
		JsonGenson impl = new JsonGenson();
