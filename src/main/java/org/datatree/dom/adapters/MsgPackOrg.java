 ...
 * <br>
 * -Ddatatree.msgpack.reader=org.datatree.dom.adapters.MsgPackOrg<br>
 * -Ddatatree.msgpack.writer=org.datatree.dom.adapters.MsgPackOrg<br>
 * <br>
...
public class MsgPackOrg extends AbstractAdapter {
	...
	public MsgPackOrg() {
		...
		tryToAddSerializers("org.datatree.dom.adapters.MsgPackOrgBsonSerializers", mapper);
