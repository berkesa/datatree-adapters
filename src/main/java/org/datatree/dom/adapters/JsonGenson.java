 ...
 * compile group: 'com.owlike', name: 'genson', version: '1.4'<br>
 * <br>
 * <b>Set as default (using Java System Properties):</b><br>
 * <br>
 * -Ddatatree.json.reader=org.datatree.dom.adapters.JsonGenson<br>
 * -Ddatatree.json.writer=org.datatree.dom.adapters.JsonGenson<br>
 * <br>
...
public class JsonGenson extends AbstractTextAdapter {
	...
	public static final Genson create(boolean pretty) {
		...
		tryToAddSerializers("org.datatree.dom.adapters.JsonGensonBsonSerializers", builder);
