 ...
 * <br>
 * -Ddatatree.json.reader=org.datatree.dom.adapters.JsonFlex<br>
 * -Ddatatree.json.writer=org.datatree.dom.adapters.JsonFlex<br>
 * <br>
...
public class JsonFlex extends AbstractTextAdapter {
	...
	public JsonFlex() {
		...
		tryToAddSerializers("org.datatree.dom.adapters.JsonFlexBsonSerializers", map);
