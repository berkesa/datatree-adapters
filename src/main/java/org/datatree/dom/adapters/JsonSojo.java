 ...
 * <br>
 * -Ddatatree.json.reader=org.datatree.dom.adapters.JsonSojo<br>
 * -Ddatatree.json.writer=org.datatree.dom.adapters.JsonSojo<br>
 * <br>
...
public class JsonSojo extends AbstractTextAdapter {
	...
	public static final JsonSerializer create() {
		...
		boolean allInstalled = tryToAddSerializers("org.datatree.dom.adapters.JsonSojoBsonSerializers", converter);
