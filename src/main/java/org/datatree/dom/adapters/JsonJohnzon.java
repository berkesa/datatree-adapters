 ...
 * <br>
 * -Ddatatree.json.reader=org.datatree.dom.adapters.JsonJohnzon<br>
 * -Ddatatree.json.writer=org.datatree.dom.adapters.JsonJohnzon<br>
 * <br>
...
public class JsonJohnzon extends AbstractTextAdapter {
	...
	public static final Mapper create(boolean pretty) {
		...
		tryToAddSerializers("org.datatree.dom.adapters.JsonJohnzonBsonSerializers", builder);
